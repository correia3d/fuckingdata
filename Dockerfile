...
# create workdir
WORKDIR /opt/app
# copy certificate for Mubeng proxy
COPY mubeng-ca.pem /usr/local/share/ca-certificates/mubeng-ca.crt
# add packages, create nonroot user and group, update certificates
